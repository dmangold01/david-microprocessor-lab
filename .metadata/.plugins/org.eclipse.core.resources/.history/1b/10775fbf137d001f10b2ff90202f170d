...
/***********************************************************************************************************************
 * BOARD_InitPeripherals_cm33_core1 functional group
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
- custom_name_enabled: 'false'
- type_id: 'nvic'
- functional_group: 'BOARD_InitPeripherals_cm33_core1'
- peripheral: 'NVIC'
- config_sets:
  - nvic:
    - interrupt_table:
...
static void PINT_2_init(void) {
  ...
  PINT_PinInterruptConfig(PINT_2_PERIPHERAL, PINT_2_INT_0, kPINT_PinIntEnableFallEdge, cbPint);
  /* Enable PINT_2 PINT.0 callback */
  PINT_EnableCallbackByIndex(PINT_2_PERIPHERAL, kPINT_PinInt0);
}
