...
/* Definitions for BOARD_InitPeripherals_cm33_core1 functional group */
/* BOARD_InitPeripherals_cm33_core1 defines for PINT */
/* Definition of peripheral ID */
#define PINT_2_PERIPHERAL ((PINT_Type *) PINT_BASE)
/* PINT_2 interrupt vector ID (number). */
#define PINT_2_PINT_0_IRQN PIN_INT0_IRQn
/* Definition of PINT interrupt ID for interrupt 0  */
#define PINT_2_INT_0 kPINT_PinInt0
...
/* INT_0 callback function for the PINT_2 component */
extern void cbPint(pint_pin_int_t pintr, uint32_t pmatch_status);
...
void BOARD_InitPeripherals_cm33_core1(void);
